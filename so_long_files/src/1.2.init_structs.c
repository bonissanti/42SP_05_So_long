...
void	init_player_defaults(t_player *player)
{
	...
	player->sprites.mario_l[0] = NULL;
	player->sprites.mario_l[1] = NULL;
	player->sprites.mario_l[2] = NULL;
	player->sprites.mario_r[0] = NULL;
	player->sprites.mario_r[1] = NULL;
	player->sprites.mario_r[2] = NULL;
	player->sprites.mario_u[0] = NULL;
	player->sprites.mario_u[1] = NULL;
	player->sprites.mario_u[2] = NULL;
	player->sprites.mario_d[0] = NULL;
	player->sprites.mario_d[1] = NULL;
	player->sprites.mario_d[2] = NULL;
}
